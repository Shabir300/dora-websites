...
<body>
    ...
    <script>
        const SCRIPT_URL = "https://script.google.com/macros/s/AKfycby5UqMVyvuQ5GMGDploJLxjczTV7SULOcT_Qtff6ZVQK0VNF52Mh7baH8ZKgLT976Ic/exec"; 

        

        function updateDots(step) { document.querySelectorAll('.dot').forEach((d, i) => { d.classList.remove('active'); if (i + 1 === step) d.classList.add('active'); }); }
        ...
        function nextStep(current) {
            ...
            if (nextDiv) { nextDiv.classList.add('active'); updateDots(next); }
        }
        ...
        function submitForm() {
            ...
            const data = {
                ...
                read: document.getElementById('input_read').value,
                want: document.getElementById('input_want').value,
